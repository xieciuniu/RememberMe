...
extension AddFriend {
    @MainActor class ViewModel: ObservableObject {
        ...
        func newPerson() -> Friend {
            ...
            let onePerson = Friend(name: name, photo: jpegData, latitude: locationFetcher.lastKnownLocation?.latitude ?? 0.0, longitude: locationFetcher.lastKnownLocation?.longitude ?? 0.0)
